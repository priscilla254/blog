...
app.get("/", function(req,res){
  let homeContent={"homeStartingContent":homeStartingContent}
  res.render("home",homeContent)
})

app.get("/contact", function(req,res){
  let contactContent={"contactStartingContent":contactStartingContent}
  res.render("contact",contactContent)
})

app.get("/about", function(req,res){
  let aboutContent={"aboutStartingContent":aboutStartingContent}
